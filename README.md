...
完整文档索引见 **[docs/README.md](docs/README.md)**。`docs/` 按主题分目录组织（不再是平铺）：`getting-started/` 入门、`architecture/` 架构与决策记录、`guides/` 指南与配方、`operations/` 运维与质量、`sql/` 与 `testing/` 专项、`api/` 为 docfx 生成的 API 参考（生成物，勿手编）。

核心四份：

| 文档 | 定位 |
| --- | --- |
| [使用文档](docs/getting-started/使用文档.md) | 安装配置、快速上手、核心 API 与典型示例（§3.3 注册入口速查） |
| [架构文档](docs/architecture/架构文档.md) | 分层结构、真实模块依赖图、模块清单（51 个工程）、注册入口完整清单（§12） |
| [设计思路文档](docs/architecture/设计思路文档.md) | 设计动机、关键决策与权衡、数据流与扩展方式 |
| [子系统深挖](docs/architecture/子系统深挖.md) | CAP / FreeSQL / Bing.Data.Sql 的代码级实现解析 |

其他：[FAQ 与排错](docs/getting-started/FAQ与排错.md) · [API 速查索引](docs/getting-started/API速查索引.md) · [贡献指南](CONTRIBUTING.md) · [发布说明](docs/ReleaseNotes.md)

### 按需求快速入口

| 你想做的事 | 直接看 |
| --- | --- |
| **选 ORM / 比较数据访问能力** | [能力矩阵](docs/getting-started/能力矩阵.md)（三支 × 18 项能力对照 + 决策树） |
| **只知包名，不知该装哪个** | [包索引](docs/getting-started/包索引.md)（按场景反查 67 个包）／网页版 [选型向导](docs/选型向导.html) |
| **想要一行不多的最小上手代码** | 网页版 [Cheat Sheet](docs/cheatsheet.html)（可打印一页纸） |
| **要端到端场景的完整代码** | [recipes 配方集](docs/guides/recipes/README.md)（CRUD / CAP 事件 / 多租户 / RBAC / 支付 / 批量报表） |
| **读文档被术语卡住** | [术语表](docs/getting-started/术语表.md) |
| **想知道"怎么写才对"** | [最佳实践](docs/guides/最佳实践.md)（12 组 ✅/❌ 对照） |
| **从 ABP 迁移** | [ABP 迁移对照](docs/getting-started/abp-migration.md) |
| **做优化 / 上线前安全自查** | [性能指南](docs/operations/性能指南.md) · [安全指南](docs/operations/安全指南.md) |
| **想知道某个决策为何这样定** | [架构决策记录 ADR](docs/architecture/adr/README.md) |
| **跑测试 / 写新测试 / 发版打包** | [测试指南](docs/operations/测试指南.md) · [工程化文档](docs/operations/工程化文档.md) |

> 全部文档索引见 **[docs/README.md](docs/README.md)**——`docs/` 下共 **74 篇 Markdown**（含 10 份 ADR 决策记录、6 篇 recipes 配方、10 篇 `ai-workflow/` 历史资产），按 `getting-started` / `architecture` / `guides` / `operations` / `sql` / `testing` 分目录组织，顶层只保留 5 个入口文件。每个 NuGet 包目录下也各有一份 `README.md`（共 67 份，会内嵌到 nupkg 并在 nuget.org 包页面展示）。
>
> 英文读者请看 **[docs/README.en.md](docs/README.en.md)**（英文导航地图；中文是权威版本）。
...
|[Bing.Authorization.Abstractions](https://www.nuget.org/packages/Bing.Authorization.Abstractions/)|[![Bing.Authorization.Abstractions](https://img.shields.io/nuget/v/Bing.Authorization.Abstractions.svg)](https://www.nuget.org/packages/Bing.Authorization.Abstractions/)|[![Bing.Authorization.Abstractions](https://img.shields.io/nuget/vpre/Bing.Authorization.Abstractions.svg)](https://www.nuget.org/packages/Bing.Authorization.Abstractions/)|[![Bing.Authorization.Abstractions](https://img.shields.io/nuget/dt/Bing.Authorization.Abstractions.svg)](https://www.nuget.org/packages/Bing.Authorization.Abstractions/)|
...
|[Bing.EventBus.Abstractions](https://www.nuget.org/packages/Bing.EventBus.Abstractions/)|[![Bing.EventBus.Abstractions](https://img.shields.io/nuget/v/Bing.EventBus.Abstractions.svg)](https://www.nuget.org/packages/Bing.EventBus.Abstractions/)|[![Bing.EventBus.Abstractions](https://img.shields.io/nuget/vpre/Bing.EventBus.Abstractions.svg)](https://www.nuget.org/packages/Bing.EventBus.Abstractions/)|[![Bing.EventBus.Abstractions](https://img.shields.io/nuget/dt/Bing.EventBus.Abstractions.svg)](https://www.nuget.org/packages/Bing.EventBus.Abstractions/)|
|[Bing.EventBus](https://www.nuget.org/packages/Bing.EventBus/)|[![Bing.EventBus](https://img.shields.io/nuget/v/Bing.EventBus.svg)](https://www.nuget.org/packages/Bing.EventBus/)|[![Bing.EventBus](https://img.shields.io/nuget/vpre/Bing.EventBus.svg)](https://www.nuget.org/packages/Bing.EventBus/)|[![Bing.EventBus](https://img.shields.io/nuget/dt/Bing.EventBus.svg)](https://www.nuget.org/packages/Bing.EventBus/)|
|[Bing.Events.Cap.MySql](https://www.nuget.org/packages/Bing.Events.Cap.MySql/)|[![Bing.Events.Cap.MySql](https://img.shields.io/nuget/v/Bing.Events.Cap.MySql.svg)](https://www.nuget.org/packages/Bing.Events.Cap.MySql/)|[![Bing.Events.Cap.MySql](https://img.shields.io/nuget/vpre/Bing.Events.Cap.MySql.svg)](https://www.nuget.org/packages/Bing.Events.Cap.MySql/)|[![Bing.Events.Cap.MySql](https://img.shields.io/nuget/dt/Bing.Events.Cap.MySql.svg)](https://www.nuget.org/packages/Bing.Events.Cap.MySql/)|
...
|[Bing.AspNetCore.MultiTenancy](https://www.nuget.org/packages/Bing.AspNetCore.MultiTenancy/)|[![Bing.AspNetCore.MultiTenancy](https://img.shields.io/nuget/v/Bing.AspNetCore.MultiTenancy.svg)](https://www.nuget.org/packages/Bing.AspNetCore.MultiTenancy/)|[![Bing.AspNetCore.MultiTenancy](https://img.shields.io/nuget/vpre/Bing.AspNetCore.MultiTenancy.svg)](https://www.nuget.org/packages/Bing.AspNetCore.MultiTenancy/)|[![Bing.AspNetCore.MultiTenancy](https://img.shields.io/nuget/dt/Bing.AspNetCore.MultiTenancy.svg)](https://www.nuget.org/packages/Bing.AspNetCore.MultiTenancy/)|
|[Bing.MiniProfiler](https://www.nuget.org/packages/Bing.MiniProfiler/)|[![Bing.MiniProfiler](https://img.shields.io/nuget/v/Bing.MiniProfiler.svg)](https://www.nuget.org/packages/Bing.MiniProfiler/)|[![Bing.MiniProfiler](https://img.shields.io/nuget/vpre/Bing.MiniProfiler.svg)](https://www.nuget.org/packages/Bing.MiniProfiler/)|[![Bing.MiniProfiler](https://img.shields.io/nuget/dt/Bing.MiniProfiler.svg)](https://www.nuget.org/packages/Bing.MiniProfiler/)|
...
|[Bing.Data.Sql.Analyzers](https://www.nuget.org/packages/Bing.Data.Sql.Analyzers/)|[![Bing.Data.Sql.Analyzers](https://img.shields.io/nuget/v/Bing.Data.Sql.Analyzers.svg)](https://www.nuget.org/packages/Bing.Data.Sql.Analyzers/)|[![Bing.Data.Sql.Analyzers](https://img.shields.io/nuget/vpre/Bing.Data.Sql.Analyzers.svg)](https://www.nuget.org/packages/Bing.Data.Sql.Analyzers/)|[![Bing.Data.Sql.Analyzers](https://img.shields.io/nuget/dt/Bing.Data.Sql.Analyzers.svg)](https://www.nuget.org/packages/Bing.Data.Sql.Analyzers/)|
...
|[Bing.MultiTenancy.Abstractions](https://www.nuget.org/packages/Bing.MultiTenancy.Abstractions/)|[![Bing.MultiTenancy.Abstractions](https://img.shields.io/nuget/v/Bing.MultiTenancy.Abstractions.svg)](https://www.nuget.org/packages/Bing.MultiTenancy.Abstractions/)|[![Bing.MultiTenancy.Abstractions](https://img.shields.io/nuget/vpre/Bing.MultiTenancy.Abstractions.svg)](https://www.nuget.org/packages/Bing.MultiTenancy.Abstractions/)|[![Bing.MultiTenancy.Abstractions](https://img.shields.io/nuget/dt/Bing.MultiTenancy.Abstractions.svg)](https://www.nuget.org/packages/Bing.MultiTenancy.Abstractions/)|
|[Bing.MultiTenancy](https://www.nuget.org/packages/Bing.MultiTenancy/)|[![Bing.MultiTenancy](https://img.shields.io/nuget/v/Bing.MultiTenancy.svg)](https://www.nuget.org/packages/Bing.MultiTenancy/)|[![Bing.MultiTenancy](https://img.shields.io/nuget/vpre/Bing.MultiTenancy.svg)](https://www.nuget.org/packages/Bing.MultiTenancy/)|[![Bing.MultiTenancy](https://img.shields.io/nuget/dt/Bing.MultiTenancy.svg)](https://www.nuget.org/packages/Bing.MultiTenancy/)|
...
|[Bing.TextTemplating](https://www.nuget.org/packages/Bing.TextTemplating/)|[![Bing.TextTemplating](https://img.shields.io/nuget/v/Bing.TextTemplating.svg)](https://www.nuget.org/packages/Bing.TextTemplating/)|[![Bing.TextTemplating](https://img.shields.io/nuget/vpre/Bing.TextTemplating.svg)](https://www.nuget.org/packages/Bing.TextTemplating/)|[![Bing.TextTemplating](https://img.shields.io/nuget/dt/Bing.TextTemplating.svg)](https://www.nuget.org/packages/Bing.TextTemplating/)|
|[Bing.TextTemplating.Scriban](https://www.nuget.org/packages/Bing.TextTemplating.Scriban/)|[![Bing.TextTemplating.Scriban](https://img.shields.io/nuget/v/Bing.TextTemplating.Scriban.svg)](https://www.nuget.org/packages/Bing.TextTemplating.Scriban/)|[![Bing.TextTemplating.Scriban](https://img.shields.io/nuget/vpre/Bing.TextTemplating.Scriban.svg)](https://www.nuget.org/packages/Bing.TextTemplating.Scriban/)|[![Bing.TextTemplating.Scriban](https://img.shields.io/nuget/dt/Bing.TextTemplating.Scriban.svg)](https://www.nuget.org/packages/Bing.TextTemplating.Scriban/)|
...
|[Bing.Biz.OAuthLogin](https://www.nuget.org/packages/Bing.Biz.OAuthLogin/)|[![Bing.Biz.OAuthLogin](https://img.shields.io/nuget/v/Bing.Biz.OAuthLogin.svg)](https://www.nuget.org/packages/Bing.Biz.OAuthLogin/)|[![Bing.Biz.OAuthLogin](https://img.shields.io/nuget/vpre/Bing.Biz.OAuthLogin.svg)](https://www.nuget.org/packages/Bing.Biz.OAuthLogin/)|[![Bing.Biz.OAuthLogin](https://img.shields.io/nuget/dt/Bing.Biz.OAuthLogin.svg)](https://www.nuget.org/packages/Bing.Biz.OAuthLogin/)|
...
6. `SDK`以及`Runtime`
  - 构建用 SDK 由仓库根目录 [`global.json`](global.json) 固定（当前为 **.NET SDK 8.0.424**），请以此为准
  - 运行目标框架：类库默认 `netstandard2.0`；Web / 应用层为 `net6.0`

7. 单元测试以及模拟框架
  - [xUnit](https://xunit.net/)
  - [Shouldly](https://github.com/shouldly/shouldly)
  - [Moq](https://github.com/devlooped/moq)
  - [Coverlet](https://github.com/coverlet-coverage/coverlet)（覆盖率采集）
...
8. ORM
  ...
  - [FreeSQL](https://github.com/dotnetcore/FreeSql)（框架当前仅发布 MySql Provider，见《子系统深挖》）
