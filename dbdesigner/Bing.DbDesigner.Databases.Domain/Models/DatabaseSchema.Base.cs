...
namespace Bing.DbDesigner.Databases.Domain.Models {
    ...
    /// </summary>
    [DisplayName( "数据模式" )]
    public partial class DatabaseSchema : AggregateRoot<DatabaseSchema>,IDelete,IAudited {
        /// <summary>
        /// 初始化数据模式
        /// </summary>
        public DatabaseSchema() : this( Guid.Empty ) {
        }

        /// <summary>
        /// 初始化数据模式
        /// </summary>
        /// <param name="id">数据模式标识</param>
        public DatabaseSchema( Guid id ) : base( id ) {
        }
        ...
        /// 添加变更列表
        /// </summary>
        protected override void AddChanges( DatabaseSchema other ) {
