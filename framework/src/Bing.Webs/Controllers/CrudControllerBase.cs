...
namespace Bing.Webs.Controllers
{
    ...
    [Obsolete("请使用Bing.AspNetCore.Mvc.CrudControllerBase")]
        ...
        where TDto : IResponse, new()
    {
        ...
        /// </summary>
        /// <param name="service">Crud服务</param>
        protected CrudControllerBase(ICrudService<TDto, TUpdateRequest, TCreateRequest, TUpdateRequest, TQuery> service) : base(service)
        {
            _service = service;
        }
