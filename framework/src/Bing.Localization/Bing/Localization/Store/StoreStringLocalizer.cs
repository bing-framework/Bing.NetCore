...
public class StoreStringLocalizer : StringLocalizerBase
{
    ...
    public StoreStringLocalizer(ILogger logger, IMemoryCache cache, ILocalizedStore store, string type, IOptions<LocalizationOptions> options) 
        : base(cache, type, options)
    {
