...
namespace Bing.Logging
{
    ...
    public class LoggerWrapper<TCategoryName> : ILoggerWrapper<TCategoryName>
    {
        ...
        /// <inheritdoc />
        public void LogInformation(EventId eventId, Exception exception, string message, params object[] args) => Logger.LogInformation(eventId, exception, message, args);

        /// <inheritdoc />
        public void LogWarning(EventId eventId, Exception exception, string message, params object[] args) => Logger.LogWarning(eventId, exception, message, args);

        /// <inheritdoc />
        public void LogError(EventId eventId, Exception exception, string message, params object[] args) => Logger.LogError(eventId, exception, message, args);

        /// <inheritdoc />
        public void LogCritical(EventId eventId, Exception exception, string message, params object[] args) => Logger.LogCritical(eventId, exception, message, args);
    }
}
