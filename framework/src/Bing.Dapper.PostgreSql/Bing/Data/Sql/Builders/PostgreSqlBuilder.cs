...
public class PostgreSqlBuilder : SqlBuilderBase
{
    ...
    public PostgreSqlBuilder(IEntityMetadata metadata = null, ITableDatabase tableDatabase = null, IParameterManager parameterManager = null) : base(metadata, tableDatabase, parameterManager) { }
