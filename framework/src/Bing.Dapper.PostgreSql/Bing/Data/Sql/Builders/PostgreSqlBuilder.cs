...
{
    /// <inheritdoc />
    protected override DatabaseType ProviderDatabaseType => DatabaseType.PgSql;
    ...
    public PostgreSqlBuilder(IParameterManager parameterManager = null, IEntityMappingResolver entityMappingResolver = null,
    ...
    /// <inheritdoc />
    public override ISqlBuilder New() => new PostgreSqlBuilder(ParameterManager, EntityMappingResolver,
