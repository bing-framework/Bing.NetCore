...
public class OrIfNotEmptyCondition<TEntity> : ICondition<TEntity>
{
    ...
    /// <summary>
    /// 初始化一个<see cref="OrIfNotEmptyCondition{TEntity}"/>类型的实例
    /// </summary>
    /// <param name="condition1">查询条件1</param>
    /// <param name="condition2">查询条件2</param>
    /// <param name="conditions">查询条件列表</param>
    public OrIfNotEmptyCondition(
        Expression<Func<TEntity, bool>> condition1,
        Expression<Func<TEntity, bool>> condition2,
