...
public sealed class SqlUpdateOptions<TEntity> : SqlUpdateOptions where TEntity : class
{
    /// <summary>
    /// 按 CLR 属性名保存的并发原始值。
    /// </summary>
    ...
    public SqlUpdateOptions<TEntity> Original<TValue>(Expression<Func<TEntity, TValue>> selector, TValue value)
    {
