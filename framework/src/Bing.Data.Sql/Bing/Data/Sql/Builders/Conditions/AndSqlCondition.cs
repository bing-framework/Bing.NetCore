...
/// And连接条件
/// </summary>
public class AndSqlCondition : ISqlCondition
{
    /// <summary>
    /// Sql条件1
    /// </summary>
    ...
    /// <summary>
    /// 初始化一个<see cref="AndSqlCondition"/>类型的实例
    /// </summary>
    /// <param name="condition1">Sql条件1</param>
    /// <param name="condition2">Sql条件2</param>
    public AndSqlCondition(ISqlCondition condition1, ISqlCondition condition2 = null)
    {
    ...
    {
        if (condition == null || condition == NullSqlCondition.Instance)
            return;
        if (builder.Length == 0)
        {
