...
/// Or连接条件
/// </summary>
public class OrSqlCondition : ISqlCondition
{
    /// <summary>
    /// Sql条件1
    /// </summary>
    ...
    /// <summary>
    /// 初始化一个<see cref="OrSqlCondition"/>类型的实例
    /// </summary>
    /// <param name="condition1">Sql条件1</param>
    /// <param name="condition2">Sql条件2</param>
    public OrSqlCondition(ISqlCondition condition1, ISqlCondition condition2 = null)
    {
        _condition1 = condition1;
        _condition2 = condition2;
        if (condition1 != null && condition1 == NullSqlCondition.Instance)
            _condition1 = null;
        if (condition2 != null && condition2 == NullSqlCondition.Instance)
            _condition2 = null;
    }
