...
/// Sql大于等于查询条件
/// </summary>
public class GreaterEqualSqlCondition : SqlConditionBase
{
    /// <summary>
    /// 初始化一个<see cref="GreaterEqualSqlCondition"/>类型的实例
    /// </summary>
    /// <param name="parameterManager">参数管理器</param>
    /// <param name="column">列名</param>
    /// <param name="value">值</param>
    /// <param name="isParameterization">是否参数化</param>
    public GreaterEqualSqlCondition(IParameterManager parameterManager, string column, object value, bool isParameterization)
