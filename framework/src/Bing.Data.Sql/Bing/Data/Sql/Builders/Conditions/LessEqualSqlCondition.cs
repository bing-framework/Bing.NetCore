...
/// Sql小于等于查询条件
/// </summary>
public class LessEqualSqlCondition : SqlConditionBase
{
    /// <summary>
    /// 初始化一个<see cref="LessEqualSqlCondition"/>类型的实例
    /// </summary>
    /// <param name="parameterManager">参数管理器</param>
    /// <param name="column">列名</param>
    /// <param name="value">值</param>
    /// <param name="isParameterization">是否参数化</param>
    public LessEqualSqlCondition(IParameterManager parameterManager, string column, object value, bool isParameterization)
