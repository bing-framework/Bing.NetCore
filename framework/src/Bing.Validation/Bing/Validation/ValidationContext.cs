...
namespace Bing.Validation
{
    ...
    public class ValidationContext<TObject> where TObject : class, IVerifyModel<TObject>
    {
        /// <summary>
        /// 对象实例
        /// </summary>
        ...
        /// 验证策略列表
        /// </summary>
        private List<IValidationStrategy<TObject>> ValidateStrategyList { get; }
        ...
        public ValidationContext(TObject instanceToValidate)
        {
            ...
            ValidateStrategyList = new List<IValidationStrategy<TObject>>();
        }
        ...
        public void AddStrategy(IValidationStrategy<TObject> strategy)
        {
            if (strategy == null)
        ...
        public void AddStrategyList(IEnumerable<IValidationStrategy<TObject>> strategies)
        {
            if (strategies == null)
