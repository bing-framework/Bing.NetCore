...
/// <summary>
/// SQL Server 多结果集查询执行器基类。
/// </summary>
public abstract class SqlServerSqlMultipleQueryExecutorBase : SqlMultipleQueryExecutorBase
{
    /// <summary>
    /// 初始化一个<see cref="SqlServerSqlMultipleQueryExecutorBase"/>类型的实例。
    /// </summary>
