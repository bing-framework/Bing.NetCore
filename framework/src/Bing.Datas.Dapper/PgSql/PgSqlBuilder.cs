...
public class PgSqlBuilder : SqlBuilderBase
{
    ...
    public PgSqlBuilder(IEntityMetadata metadata = null, ITableDatabase tableDatabase = null, IParameterManager parameterManager = null) : base(metadata, tableDatabase, parameterManager) { }
    ...
    /// 创建Sql生成器
    /// </summary>
    public override ISqlBuilder New() => new PgSqlBuilder(EntityMetadata, TableDatabase, ParameterManager);
