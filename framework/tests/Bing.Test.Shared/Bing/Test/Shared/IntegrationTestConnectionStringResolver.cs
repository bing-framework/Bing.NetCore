...
public static class IntegrationTestConnectionStringResolver
{
    ...
    /// <returns>Provider 专属连接字符串，未配置时回退默认连接字符串。</returns>
    ...
    public static string Resolve(string provider)
    {
        ...
        throw new InvalidOperationException(
            ...
            $"{DefaultConnectionEnvironmentVariable}。Visual Studio 请使用 " +
            $"tests/runsettings/{settings.RunSettingsFileName}。");
    }
    ...
    private static ProviderSettings GetSettings(string provider)
    {
        ...
        return normalizedProvider switch
        {
            ...
            "SQLSERVER" => new ProviderSettings("SqlServer", "ConnectionStrings__SqlServerConnection",
                "integration.sqlserver.runsettings.example"),
            "ORACLE" => new ProviderSettings("Oracle", "ConnectionStrings__OracleConnection",
                "integration.oracle.runsettings.example"),
    ...
    private sealed class ProviderSettings
    {
        ...
        /// <param name="runSettingsFileName">runsettings 示例文件名称。</param>
        public ProviderSettings(string provider, string connectionEnvironmentVariable, string runSettingsFileName)
        {
            Provider = provider;
        ...
        /// <summary>
        /// 获取 runsettings 示例文件名称。
        /// </summary>
        public string RunSettingsFileName { get; }
    }
}