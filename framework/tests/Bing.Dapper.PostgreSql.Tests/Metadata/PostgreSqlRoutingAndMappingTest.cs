...
public class PostgreSqlRoutingAndMappingTest
{
    ...
    /// <summary>
    /// 创建绑定 reporting PostgreSQL 数据源的测试 SQL 配置。
    /// </summary>
    /// <returns>带固定 PostgreSQL 数据源上下文的 SQL 配置。</returns>
    ...
    /// <summary>
    /// 组合测试所需共享服务后创建 PostgreSQL Builder。
    /// </summary>
    ...
    /// <returns>使用给定测试服务的 PostgreSQL Builder。</returns>
    private static PostgreSqlBuilder CreateBuilder(IEntityMappingResolver entityMappingResolver = null,
