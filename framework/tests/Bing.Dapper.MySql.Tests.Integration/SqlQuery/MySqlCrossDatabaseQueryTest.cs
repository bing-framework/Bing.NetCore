...
public sealed class MySqlCrossDatabaseQueryTest
{
    ...
    public async Task AppendFrom_WhenCrossDatabaseIsEnabled_ShouldExecuteDottedPhysicalTableQuery()
    {
        ...
        try
        {
            ...
            var description = query.Sql<CrossDatabaseCompanyResult>().AppendSelect("c.CompanyId,c.Name")
    ...
    public async Task From_WhenUsingQualifiedDottedPhysicalTable_ShouldExecuteQuery()
    {
        ...
        try
        {
            ...
            using var query = _fixture.CreateQuery();
            var description = query.Sql<CrossDatabaseCompanyResult>().Select("c.CompanyId,c.Name")
                .From(tableName, "c")
                .Where("c.CompanyId", companyId);
    ...
    public async Task From_WhenUsingStructuredCrossDatabaseReference_ShouldExecuteDottedPhysicalTableQuery()
    {
        ...
        try
        {
            ...
            description.Where("c.CompanyId", companyId);
    ...
    public async Task LeftJoin_WhenUsingStructuredCrossDatabaseReference_ShouldExecuteAndPreserveUnmatchedRows()
    {
        ...
        try
        {
            ...
            using var matchedRootQuery = _fixture.CreateQuery();
            var matchedQuery = CreateStructuredCrossDatabaseJoinQuery(matchedRootQuery, databaseName, matchedCompanyId);
    ...
    public async Task Join_WhenUsingQualifiedDottedPhysicalTable_ShouldExecuteQuery()
    {
        ...
        try
        {
            ...
            using var query = _fixture.CreateQuery();
            var description = query.Sql<CrossDatabaseCompanyResult>().Select("c.CompanyId,c.Name,m.Name As MerchantName")
        ...
        string databaseName, Guid companyId)
    {
        ...
        description.AppendOn("c.MerchantId=m.MerchantId");
        description.Where("c.CompanyId", companyId);
        return description;
    }
