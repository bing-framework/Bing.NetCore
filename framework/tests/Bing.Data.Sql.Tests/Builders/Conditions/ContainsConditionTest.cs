...
public class ContainsConditionTest
{
    ...
    public void Test_Create_Validate()
    {
        Assert.Throws<ArgumentNullException>(() => {
            var condition = new ContainsSqlCondition(_parameterManager, "", 1, true);
        });
    }
    ...
    {
        var condition = new ContainsSqlCondition(_parameterManager, "a", "b", true);
    ...
    {
        var condition = new ContainsSqlCondition(_parameterManager, "a", "b", false);
