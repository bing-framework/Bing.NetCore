...
public class GreaterEqualConditionTest
{
    ...
    public void Test_Create_Validate()
    {
        Assert.Throws<ArgumentNullException>(() => {
            var condition = new GreaterEqualSqlCondition(_parameterManager, "", 1, true);
        });
    }
    ...
    {
        var condition = new GreaterEqualSqlCondition(_parameterManager, "a", 1, true);
    ...
    {
        var condition = new GreaterEqualSqlCondition(_parameterManager, "a", "b", false);
    ...
    public void Test_GetCondition_3()
    {
        ...
        var condition = new GreaterEqualSqlCondition(_parameterManager, "a", builder, true);
