...
public class ColumnItemTest
{
    ...
    public void Test_1()
    {
        var item = new ColumnItemV1(_dialect, "a");
    ...
    public void Test_2()
    {
        var item = new ColumnItemV1(_dialect, "a.b");
        Assert.Equal("a", item.TableAlias);
        Assert.Equal("b", item.Name);
    }

    /// <summary>
    /// 测试 - 解析带表别名和列别名的列 - 使用as关键字
    /// </summary>
    [Fact]
    public void Test_3()
    {
        var item = new ColumnItemV1(_dialect, "a.b as c");
        Assert.Equal("a", item.TableAlias);
        Assert.Equal("b", item.Name);
    ...
    /// <summary>
    /// 测试 - 解析带表别名和列别名的列 - 使用空格
    /// </summary>
    [Fact]
    public void Test_5()
    {
        var item = new ColumnItemV1(_dialect, "a.b c");
        Assert.Equal("a", item.TableAlias);
        Assert.Equal("b", item.Name);
        Assert.Equal("c", item.ColumnAlias);
    }
    ...
    /// <summary>
    /// 测试 - 获取Sql结果 - 带表别名和列别名的列
    /// </summary>
    [Fact]
    public void Test_ToSql_3()
    {
        var item = new ColumnItemV1(_dialect, "a.b as c");
