...
public class WhereClauseTest
{
    ...
    public void Test_Where_3()
    {
        ...
        Assert.Equal("a", _parameterManager.GetParamValue("@_p_0"));
        Assert.Equal("b", _parameterManager.GetParamValue("@_p_1"));
    }
    ...
    public void Test_Where_WithLambda_2()
    {
        ...
        Assert.Equal("a", manager.GetParamValue("@_p_0"));
    }
    ...
    public void Test_Where_WithLambda_WithOperatorResolve_Or_1()
    {
        ...
        Assert.Equal("a", _parameterManager.GetParamValue("@_p_0"));
        Assert.Equal("%b%", _parameterManager.GetParamValue("@_p_1"));
        Assert.Equal(1, _parameterManager.GetParamValue("@_p_2"));
        Assert.Equal("c", _parameterManager.GetParamValue("@_p_3"));
        Assert.Equal(2, _parameterManager.GetParamValue("@_p_4"));
    }
    ...
    public void Test_Where_WithLambda_WithOperatorResolve_11()
    {
        ...
        Assert.Equal(0, _parameterManager.GetSqlParams().Count);
    }
    ...
    public void Test_Where_WithLambda_WithOperatorResolve_12()
    {
        ...
        Assert.Equal("Where [Email]=@_p_0", GetSql());
        Assert.Equal("", _parameterManager.GetParamValue("@_p_0"));
    }
    ...
    public void Test_In_1()
    {
        ...
        Assert.Equal("a", _parameterManager.GetParamValue("@_p_0"));
        Assert.Equal("b", _parameterManager.GetParamValue("@_p_1"));
        Assert.Equal(2, _parameterManager.GetSqlParams().Count);
    }
    ...
    public void Test_In_4()
    {
        ...
        //验证
        Assert.Equal(result.ToString(), GetSql());
        Assert.Equal(SampleEnum.One, _parameterManager.GetParamValue("@_p_0"));
        Assert.Equal(SampleEnum.Two, _parameterManager.GetParamValue("@_p_1"));
        Assert.Equal(SampleEnum.Three, _parameterManager.GetParamValue("@_p_2"));
        Assert.Equal(3, _parameterManager.GetSqlParams().Count);
    }
    ...
    public void Test_Between_Int_1()
    {
        ...
        //验证
        Assert.Equal(1, _parameterManager.GetParamValue("@_p_0"));
        Assert.Equal(2, _parameterManager.GetParamValue("@_p_1"));
        Assert.Equal(result.ToString(), GetSql());
    }
    ...
    public void Test_Between_Int_4()
    {
        ...
        //验证
        Assert.Equal(2, _parameterManager.GetParamValue("@_p_0"));
        Assert.Equal(result.ToString(), GetSql());
    }
    ...
    public void Test_Between_Int_6()
    {
        ...
        //验证
        Assert.Empty(_parameterManager.GetSqlParams());
        Assert.Null(GetSql());
    }
    ...
    public void Test_Between_Double_1()
    {
        ...
        //验证
        Assert.Equal(1.2, _parameterManager.GetParamValue("@_p_0"));
        Assert.Equal(3.4, _parameterManager.GetParamValue("@_p_1"));
        Assert.Equal(result.ToString(), GetSql());
    }
    ...
    public void Test_Between_Decimal_1()
    {
        ...
        //验证
        Assert.Equal(1.2M, _parameterManager.GetParamValue("@_p_0"));
        Assert.Equal(3.4M, _parameterManager.GetParamValue("@_p_1"));
        Assert.Equal(result.ToString(), GetSql());
    }
    ...
    public void Test_Between_DateTime_1()
    {
        ...
        //验证
        Assert.Equal(min, _parameterManager.GetParamValue("@_p_0"));
        Assert.Equal(max, _parameterManager.GetParamValue("@_p_1"));
        Assert.Equal(result.ToString(), GetSql());
    }
    ...
    public void Test_Between_DateTime_2()
    {
        ...
        //验证
        Assert.Equal(DateTime.Parse("2000-1-1"), _parameterManager.GetParamValue("@_p_0"));
        Assert.Equal(DateTime.Parse("2000-1-3"), _parameterManager.GetParamValue("@_p_1"));
        Assert.Equal(result.ToString(), GetSql());
    }
    ...
    public void Test_Between_DateTime_6()
    {
        ...
        //验证
        Assert.Equal(DateTime.Parse("2000-1-3"), _parameterManager.GetParamValue("@_p_0"));
        Assert.Equal(result.ToString(), GetSql());
    }
    ...
    public void Test_Between_DateTime_7()
    {
        ...
        //验证
        Assert.Equal(max, _parameterManager.GetParamValue("@_p_0"));
        Assert.Equal(result.ToString(), GetSql());
    }
