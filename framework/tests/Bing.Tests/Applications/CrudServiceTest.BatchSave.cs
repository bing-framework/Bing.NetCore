...
public partial class CrudServiceTest
{
    ...
    /// </summary>
    [Fact]
    public async Task Test_Save_Empty()
    {
    ...
    /// </summary>
    [Fact]
    public async Task Test_Save_FilterAddListByDeleteList()
    {
    ...
    /// </summary>
    [Fact]
    public async Task Test_Save_FilterUpdateListByDeleteList()
    {
        var input = new List<DtoSample> { new DtoSample { Id = "1" } };
    ...
    /// </summary>
    [Fact]
    public async Task Test_Save_Add_Repeat()
    {
    ...
    /// </summary>
    [Fact]
    public async Task Test_Save_Delete_Repeat()
    {
        var input = new List<DtoSample> {
            new DtoSample{Id = _id.ToString()},
            new DtoSample{Id = _id.ToString()}
    ...
    /// </summary>
    [Fact]
    public async Task Test_SaveAsync_Add_1()
    {
        var input = new List<DtoSample> {
            new DtoSample{Id = _id.ToString()}
        };
    ...
    /// </summary>
    [Fact]
    public async Task Test_SaveAsync_Add_2()
    {
        var input = new List<DtoSample> {
            new DtoSample{Id = _id.ToString()},
    ...
    /// </summary>
    [Fact]
    public async Task Test_SaveAsync_Delete_1()
    {
        var input = new List<DtoSample> {
            new DtoSample{Id = _id.ToString()}
        };
