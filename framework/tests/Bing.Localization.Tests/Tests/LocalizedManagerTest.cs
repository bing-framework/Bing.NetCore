...
public class LocalizedManagerTest
{
    ...
    /// </summary>
    [Fact]
    public void Test_LoadAllResources_1()
    {
        // 设置返回资源
    ...
    /// <summary>
    /// 测试 - 加载全部资源 - 本地化配置设置区域文化 - 多个区域文化
    /// </summary>
    [Fact]
    public void Test_LoadAllResources_2()
    {
        //设置区域文化
    ...
    /// </summary>
    [Fact]
    public void Test_LoadAllResources_3()
    {
        //设置区域文化
        _mockLocalizedStore.Setup(t => t.GetCultures()).Returns(new[] { "en-US" });
    ...
    /// </summary>
    [Fact]
    public void Test_LoadAllResources_4()
    {
        //设置区域文化
        _mockLocalizedStore.Setup(t => t.GetCultures()).Returns(new[] { "en-US" });
