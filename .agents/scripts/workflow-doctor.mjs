...
const checks = [
  ...
  '.agents/scripts/sync-agent-profiles.mjs',
  '.agents/agent-profiles.json',
  '.agents/templates/agent-profiles.template.json',
  '.agents/scripts/init-agent-profiles.mjs',
  '.agents/scripts/task-state.mjs',
  '.agents/scripts/task-finish.mjs',
  '.agents/scripts/workflow-notify.mjs',
  '.agents/scripts/goal-task.mjs',
  '.agents/scripts/copilot-hook.mjs',
  ...
  '.agents/workflows/create-plan.md',
  ...
  '.github/prompts/draft-plan.prompt.md',
  '.github/prompts/inspect-code.prompt.md',
];
