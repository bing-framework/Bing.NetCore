...
namespace Bing.Admin.Data.Repositories.Systems
{
    ...
    public class RoleRepository : TreeRepositoryBase<Role>, IRoleRepository, IRoleStore<Role>
    {
        ...
        public RoleRepository(IAdminUnitOfWork unitOfWork, ISqlQueryFactory sqlQueryFactory,
        ...
        {
            return from role in Set.Select.AsQueryable()
                   join userRole in UnitOfWork.Set<UserRole>().Select.AsQueryable() on role.Id equals userRole.RoleId
