...
namespace Bing.Ui.Configs
{
    ...
    public class Config : IConfig
    {
        ...
        public void Load(Context context)
        {
            ...
            Context = new TagHelperContext(AllAttributes, context.TagHelperContext.Items,
                context.TagHelperContext.UniqueId);
