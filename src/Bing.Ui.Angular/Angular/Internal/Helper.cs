...
namespace Bing.Ui.Angular.Internal
{
    ...
    internal static class Helper
    {
        ...
        public static void Init<TModel, TProperty>(IConfig config, Expression<Func<TModel, TProperty>> expression,
            MemberInfo member)
        {
            var modelType = Common.GetType<TModel>();
        ...
        {
            var modelType = expression.Metadata.ContainerType;
