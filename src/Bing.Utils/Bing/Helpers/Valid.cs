...
namespace Bing.Helpers
{
    ...
    public static partial class Valid
    {
        ...
        public static bool IsBase64String(string value) => value.IsMatch(@"[A-Za-z0-9\+\/\=]");
        ...
        /// </summary>
        /// <param name="value">值</param>
        public static bool IsUpperCaseChar(char value) => IsUpperCaseChar(value.ToString());
        ...
        /// </summary>
        /// <param name="value">值</param>
        public static bool IsLowerCaseChar(char value) => IsLowerCaseChar(value.ToString());
