...
namespace Bing.Extensions
{
    ...
    public static partial class BingExtensions
    {
        ...
        /// <param name="instance">枚举实例</param>
        public static TResult Value<TResult>(this System.Enum instance) => Bing.Helpers.Conv.To<TResult>(Value(instance));
        ...
        public static string Join<T>(this IEnumerable<T> list, string quotes = "", string separator = ",") => Str.Join(list, quotes, separator);
