...
namespace Bing.Extensions
{
    ...
    public static class LongExtensions
    {
        ...
        public static bool InRange(this long value, long minValue, long maxValue) => value >= minValue && value <= maxValue;
        ...
        /// <returns></returns>
        public static long InRange(this long value, long minValue, long maxValue, long defaultValue) => value.InRange(minValue, maxValue) ? value : defaultValue;
        ...
        /// <returns>返回的字符串包含序号标记毗邻的数字表示</returns>
        public static string ToOrdinal(this long i, string format) => string.Format(format, i.ToOrdinal());
        ...
        public static TimeSpan Days(this long days) => TimeSpan.FromDays(days);
        ...
        public static TimeSpan Hours(this long hours) => TimeSpan.FromHours(hours);
        ...
        public static TimeSpan Minutes(this long minutes) => TimeSpan.FromMinutes(minutes);
        ...
        public static TimeSpan Milliseconds(this long milliseconds) => TimeSpan.FromMilliseconds(milliseconds);
