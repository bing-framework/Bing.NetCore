...
namespace Bing.Datas.Sql.Queries
{
    ...
    public static partial class Extensions
    {
        ...
        /// <param name="boundary">包含边界</param>
        /// <returns></returns>
        public static ISqlQuery Between(this ISqlQuery sqlQuery, string column, long? min, long? max, Boundary boundary = Boundary.Both)
        {
            var builder = sqlQuery.GetBuilder();
            builder.Between(column, min, max, boundary);
            return sqlQuery;
        ...
        /// <param name="boundary">包含边界</param>
        /// <returns></returns>
        public static ISqlQuery Between(this ISqlQuery sqlQuery, string column, float? min, float? max, Boundary boundary = Boundary.Both)
        {
            var builder = sqlQuery.GetBuilder();
            builder.Between(column, min, max, boundary);
            return sqlQuery;
        ...
        #region AppendGroupBy(添加到GroupBy子句)
        ...
        #region AppendOrderBy(添加到OrderBy子句)
