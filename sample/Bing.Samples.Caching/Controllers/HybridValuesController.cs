...
namespace Bing.Samples.Caching.Controllers
{
    ...
    /// 混合缓存值控制器
    /// </summary>
    public class HybridValuesController:ApiControllerBase
    {
        /// <summary>
        /// 混合缓存提供程序
        /// </summary>
        ...
        /// <summary>
        /// 初始化一个<see cref="HybridValuesController"/>类型的实例
        /// </summary>
        public HybridValuesController(IHybridCacheProvider hybridCacheProvider)
        {
            _cacheProvider = hybridCacheProvider;
        }
