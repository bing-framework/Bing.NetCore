...
namespace Bing.Tests.Samples
{
    ...
    public class RepositorySample : IRepositorySample
    {
        ...
        public async Task<EntitySample> FindAsync(object id, CancellationToken cancellationToken = default(CancellationToken))
        {
            throw new NotImplementedException();
        }
        ...
        public async Task<List<EntitySample>> FindByIdsAsync(IEnumerable<Guid> ids, CancellationToken cancellationToken = default(CancellationToken))
        {
            throw new NotImplementedException();
        }
        ...
        public async Task<EntitySample> FindByIdNoTrackingAsync(Guid id, CancellationToken cancellationToken = default(CancellationToken))
        {
            throw new NotImplementedException();
        }
        ...
        public async Task<List<EntitySample>> FindByIdsNoTrackingAsync(IEnumerable<Guid> ids, CancellationToken cancellationToken = default(CancellationToken))
        {
            throw new NotImplementedException();
        }
        ...
        public async Task<EntitySample> SingleAsync(Expression<Func<EntitySample, bool>> predicate, CancellationToken cancellationToken = default(CancellationToken))
        {
            throw new NotImplementedException();
        }
        ...
        public async Task AddAsync(EntitySample entity, CancellationToken cancellationToken = default(CancellationToken))
        {
            throw new NotImplementedException();
        }

        public async Task AddAsync(IEnumerable<EntitySample> entities, CancellationToken cancellationToken = default(CancellationToken))
        {
            throw new NotImplementedException();
        }
        ...
        public async Task RemoveAsync(IEnumerable<Guid> ids, CancellationToken cancellationToken = default(CancellationToken))
        {
            throw new NotImplementedException();
        }

        public async Task RemoveAsync(IEnumerable<EntitySample> entities, CancellationToken cancellationToken = default(CancellationToken))
        {
            throw new NotImplementedException();
        }
    }
