...
public class RepositorySample : IRepositorySample
{
    ...
    /// </summary>
    /// <param name="condition">查询条件</param>
    public Task<List<EntitySample>> FindAllAsync(Expression<Func<EntitySample, bool>> condition = null)
    {
        throw new NotImplementedException();
    }
    ...
    /// </summary>
    /// <param name="condition">查询条件</param>
    public Task<List<EntitySample>> FindAllNoTrackingAsync(Expression<Func<EntitySample, bool>> condition = null)
    {
        throw new NotImplementedException();
    }
    ...
    /// </summary>
    /// <param name="condition">查询条件</param>
    public Task<int> CountAsync(Expression<Func<EntitySample, bool>> condition = null)
    {
        throw new NotImplementedException();
    }
